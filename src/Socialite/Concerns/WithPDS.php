...
trait WithPDS
{
    ...
    {
        if (! is_null($this->login_hint) && Str::startsWith($this->login_hint, 'https://') && Str::isUrl($this->login_hint, ['https', 'http']) && $this->isSafeUrl($this->login_hint)) {
    ...
    /**
     * @return ($key is non-empty-string ? array|string : ProtectedResource)
     */
    protected function pdsProtectedResource(string $pds_url, string $key = '', string $default = ''): ProtectedResource|array|string
    {
